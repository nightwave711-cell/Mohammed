head -n -53 app/src/main/java/com/example/ui/screens/EditorScreen.kt > temp.kt
cat << 'INNEREOF' >> temp.kt
...
tail -n 76 app/src/main/java/com/example/ui/screens/EditorScreen.kt | head -n 75 >> temp.kt
mv temp.kt app/src/main/java/com/example/ui/screens/EditorScreen.kt
